...
document.getElementById("reminder-bar").style.display='none';
 fetch(`/reminder`, {
  ...
  .then(data => {
    ...
    let container=document.getElementById("yesterday");
    let baseText1 = document.createElement('span');
    let baseText2 = document.createElement('span');
    let baseText3 = document.createElement('span');
    let baseText4 = document.createElement('span');
    baseText1.textContent='Did you ';
    baseText2.textContent=`${data['0']['activity']}`;
    if(today.getDay()==time2.getDay()){
      baseText3.textContent=` yesterday`;
    }else{
      baseText3.textContent=` ${weekday[time2.getDay()]}`;
    }
    
    baseText4.textContent=' ?';
    container.appendChild(baseText1);
    container.appendChild(baseText2);
    container.appendChild(baseText3);
    container.appendChild(baseText4);
    ...
    document.getElementById("pAct-date").value=time1;
    document.getElementById("pAct-activity").value=data['0']['activity'];
